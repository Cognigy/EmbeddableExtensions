...
declare const nodeFieldTypes: readonly ["text", "rule", "json", "checkbox", "time", "date", "datetime", "select", "typescript", "xml", "textArray", "chipInput", "cognigyText", "toggle", "slider", "number", "daterange", "connection", "say", "condition"];
...
export interface INodeFieldCondition {
